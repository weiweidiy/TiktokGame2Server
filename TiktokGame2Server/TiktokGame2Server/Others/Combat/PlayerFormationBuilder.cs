...
namespace TiktokGame2Server.Others
{
    public class PlayerFormationBuilder : IJCombatFormationBuilder
    {
        ...
        public List<JCombatFormationInfo> Build()
        {
            ...
            {
                var builder = new PlayerUnitBuilder(new PlayerAttrBuilder(f.PlayerId, f.SamuraiId), new PlayerActionsBuilder(f.PlayerId, f.SamuraiId,recorder,tiktokConfigService), f.Samurai);

...
{
    public class LevelNodeUnitBuilder : IJCombatUnitBuilder
    {
        public JCombatUnitInfo Build(int levelNodeUnitId)
        {
            var info = new JCombatUnitInfo();
            info.Uid = "unit"+ levelNodeUnitId;
            info.AttrList = new FakeAttrFacotry2().Create();
            return info;
        }
    }
}

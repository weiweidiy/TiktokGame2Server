...
namespace TiktokGame2Server.Migrations
{
    ...
    [Migration("20250717103518_initCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.Account", b =>
                {
                    b.HasOne("TiktokGame2Server.Entities.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("TiktokGame2Server.Entities.Chapter", b =>
                {
                    b.HasOne("TiktokGame2Server.Entities.User", null)
                        .WithMany("Chapters")
                        .HasForeignKey("UserId");
                });
